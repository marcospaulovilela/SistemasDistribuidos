...
namespace TheGraph.Thrift
{
  public partial class TheGraph {
    ...
    public interface Iface : ISync {
      #if SILVERLIGHT
      IAsyncResult Begin_G(AsyncCallback callback, object state);
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_G(AsyncCallback callback, object state)
      {
        return send_G(callback, state);
      }
      ...
      public graph G()
      {
        ...
        #else
        var asyncResult = Begin_G(null, null);
        return End_G(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_G(AsyncCallback callback, object state)
      #else
      public void send_G()
      #endif
      {
